    ...
    <Countdown date={1657446668958 + 2073600000} className="countdown">
      ...
      >
        <Router>
          ...
          >
            <p>
              Transaction created successfully. Click here to view your
              INVENTORY.
            </p>
          </Link>
          <Link
          ...
          >
            <p>
              Depreciation calculated successfully. Click here to view your
              CAPEX page.
            </p>
          </Link>
          <div
            className={capexTxn ? "opex-alert show-opex-alert" : "opex-alert"}
          >
