...
export const Anticoccidiosis = () => {
  const [returnedExpenses, setReturnedExpenses] = useState([]);
  const [returnedAnticoccidiosis, setReturnedAnticoccidiosis] = useState([]);
  ...
  const [anticoccidiosis, setAnticoccidiosis] = useState({
    LastUpdated: "",
    Producer: "",
    Brand: "",
    Mediums: "",
  ...
  console.log(returnedAnticoccidiosis);
  //   getting the data from the database from the db end-----------------------------------------

  let allAnticoccidiosis = returnedAnticoccidiosis.name;

  const sortAnticoccidiosis =
    returnedAnticoccidiosis.name && search
      ? returnedAnticoccidiosis.name.filter((sortedAnticoccidiosis) =>
          sortedAnticoccidiosis.Brand.toLowerCase().includes(
            search.toLowerCase()
          )
        )
      : allAnticoccidiosis;
            ...
            {returnedAnticoccidiosis.name ? (
              <div className="all-farm-hands">
                <table>
                  ...
                  {returnedAnticoccidiosis.name &&
                    sortAnticoccidiosis.map((anticoccidiosis) => {
                      const {
                        AnticoccidiosisId,
                        LastUpdated,
                        Producer,
